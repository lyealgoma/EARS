...
public class AdminDashBoardView extends Application {
  ...
  public void start(Stage ps) throws Exception {
    ...
    ObservableList<FacultySearchEntity> items = FXCollections.observableArrayList(new FacultySearchEntity("English"),new FacultySearchEntity("Math"));
    ...
    facultySearchesListView.setStyle("-fx-control-inner-background: #a9a9a9;-fx-font-size: 24px; -fx-font-family: 'SketchFlow Print';");
